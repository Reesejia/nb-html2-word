...
import { getImageBase64 } from '../../utils/img'
import { TextNode } from 'node-html-parser'
import { WidthHeightfy } from '../StyleStrategy'
...
class Imagefy {
  ...
  static canvasTobase64(dom: HTMLElement, options): Promise<string> {
